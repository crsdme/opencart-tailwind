...
class __TwigTemplate_b900a7d74ed0dc13b1a40a9b9d72ec2a855c399fdd0e7106f407797eb7bbb015 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <body class=\"p-8 bg-white text-black space-y-12\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["component"]) {
            ...
            echo "</h2>
                ";
            // line 16
            $this->loadTemplate((("tailwind/components/" . $context["component"]) . ".twig"), "tailwind/template/common/components.twig", 16)->display($context);
            // line 17
            echo "            </section>
        ";
            ++$context['loop']['index0'];
