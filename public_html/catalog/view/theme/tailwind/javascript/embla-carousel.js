!(function (n, t) {
        ...
        return {
            ...
            constrain: function (i) {
                ...
                const a = n.reachedMin(t.get()) ? 'min' : 'max',
                    ...
                    p = s.constrain(l / u);
                (e.subtract(f * p),
                    !i && o(f) < c && (e.set(n.constrain(e.get())), r.useDuration(25).useBaseFriction()));
            },
            ...
            In = (function (n, t, e, r, c, u) {
                ...
                const h = {
                    ...
                    seek: function () {
                        ...
                        return (
                            d
                                ? (e.set(n), (s += t / d), (s *= l), (f += s), n.add(s), (o = f - p))
            ...
            An = (function (n, t, e, r, o, i, c) {
                function u(o) {
                    const u = o.distance,
                        s = o.index !== t.get();
                    (i.add(u),
                        u && (r.duration() ? n.start() : (n.update(), n.render(1), n.update())),
    ...
    function k(n, e, r) {
        const o = n.ownerDocument,
            ...
            u = (function (n) {
                ...
                return {
                    init: function (e, r) {
                        return (
                            (t = r.filter(({ options: t }) => !1 !== n.optionsAtMedia(t).active)),
        ...
        function T(n, t, e) {
            L.active &&
                !w &&
                (y.scrollBody.useBaseFriction().useDuration(!0 === t ? 0 : L.duration), y.scrollTo.index(n, e || 0));
        }
        function O() {
            return y.index.get();
        }
...
!(function (n, t) {
    'object' == typeof exports && 'undefined' != typeof module
        ...
        : 'function' == typeof define && define.amd
          ? define(t)
          : ((n = 'undefined' != typeof globalThis ? globalThis : n || self).EmblaCarouselAutoplay = t());
})(this, function () {
    'use strict';
    const n = {
        active: !0,
        ...
        return {
            ...
            init: function (r, u) {
                ...
                (E.add(I, 'visibilitychange', y),
                    ...
                    e.stopOnMouseEnter && !e.stopOnInteraction && E.add(T, 'mouseleave', b),
                    e.stopOnFocusIn && i.on('slideFocusStart', m),
                    e.stopOnFocusIn && !e.stopOnInteraction && E.add(i.containerNode(), 'focusout', d),
                    e.playOnInit && d());
            },
            destroy: function () {
