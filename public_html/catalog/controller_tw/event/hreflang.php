...
class ControllerEventHreflang extends Controller
{
	public function index(&$route, &$data, &$code)
	{
		...
		$hreflang[] = [
			'href' => $this->multilang->linkForLanguage('', $route_for_link, $args, false, $languages),
			'hreflang' => 'x-default',
		];
		...
		foreach ($languages as $lang) {
			...
			$hreflang[] = [
				'href' => $this->multilang->linkForLanguage($lang['code'], $route_for_link, $args, false, $languages),
				'hreflang' => $lang['code'],
			];
		}
